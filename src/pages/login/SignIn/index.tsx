...
export default function SignIn() {
  ...
  const validateComponentsForLogin = () => {
    try {
      ...
      // console.log('loginValidate 1::',validatingMnemonic)
      ...
      // console.log('loginValidate 2::',loginValidate)
  ...
  const handleShowToastMsg = () => {
    if (toastMsgRef.current) {
      toastMsgRef.current.showAlert("Clipboard API is not supported!", "error");
    }
  };
  const assignSeed = async () => {
    ...
    if (navigator.clipboard && navigator.clipboard.readText) {
      ...
      // setShowErrMsg(true);
      // setErrMsg("Clipboard API is not supported");
      handleShowToastMsg()
        ...
        {!showSignWithKey && (
          ...
          >
            ...
            >
              ...
              <Typography mt={3} sx={{ fontWeight: 700, fontSize: "1.1rem" }}>
                Recovery Seed
              </Typography>
