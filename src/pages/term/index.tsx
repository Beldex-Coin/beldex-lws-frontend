...
const Terms = () => {
    return (
        <Box>
            {/* <Typography sx={{color: 'white',fontSize: '20px',textAlign: 'center',fontWeight: 500,margin: '40px'}}>Terms Page</Typography> */}
            <Typography sx={{ color: 'white', fontSize: '20px', fontWeight: 700, margin: '40px 40px 25px' }}>Terms of Service</Typography>
            <Box sx={{ color: 'white', fontSize: '20px', margin: '0px 40px 40px' }}>
                ...
                <Typography sx={{ marginTop: '20px', fontWeight: 700 }}>
                    4.4. No Storage or Transmission of Beldex.
                    <Typography component={"span"}>
                ...
                <Typography sx={{ marginTop: '20px', fontWeight: 700 }}>
                    ...
                    <Typography component={'ul'} sx={{ marginTop: '20px' }}>
                        <Typography component={'li'} sx={{ fontWeight: 700 }}>
